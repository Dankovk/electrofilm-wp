    ...
    <div id="fullpage">
        <div class="section" data-anchor="directors">
            ...
            <div class="nav">
                <ul>
                    <li>
                        <a class="current-link" href="#directors">
                            Режисери
                        </a>
                    </li>
                    <li>
        ...
        <div class="section" data-anchor="reviews">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a  class="current-link" href="#reviews">
                            Рецензії
                        </a>
                    </li>
                    <li>
        ...
        <div class="section" data-anchor="movies">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a class="current-link" href="#movies">
                            Фільми
                        </a>
                    </li>
                    <li>
        ...
        <div data-anchor="headSection" class="section active">
            <div class="layout-container">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a   class="active current-link" href="#mainPage">
                            Electro.Film
                        </a>
                    </li>
                    <li>
        ...
        <div class="section" data-anchor="about">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a class="current-link"  href="#about">
                            Про проект
                        </a>
                    </li>
                    <li>
        ...
        <div class="section" data-anchor="events">
            ...
            <div class="nav">
                <ul>
                    ...
                    <li>
                        <a class="current-link" href="#events">
                            Афіша
                        </a>
                    </li>
                    <li>
...
<!--                        </div>-->
            ...
            <div class="nav footer-nav">
                <ul>
                    ...
                    <li>
                        <a class="current-link" href="#contacts">
                            Контакти
                        </a>
                    </li>
                </ul>
